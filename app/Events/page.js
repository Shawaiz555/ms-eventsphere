    ...
    <div>
      <div>
        ...
        <div className="mt-10 py-20 bg-[#fff000]">
          <h1 className="text-center text-4xl md:text-6xl font-semibold">Attend a MS-EventSphere event</h1>
          <div className="w-full flex justify-center my-5">
            <div className="w-full lg:w-[50%] px-5 lg:px-10">
              <p className="text-xl">Join us for event industry webinars, in-person events, and more. Whether you prefer to attend live or watch on-demand, you’ll get the industry’s top insights and thought leadership.</p>
            </div>
          </div>
        ...
        <div className="w-full mt-20 flex flex-col lg:flex-row gap-5 lg:gap-20 px-10 lg:px-20">
          ...
          <div className="w-full lg:w-[50%] py-20">
