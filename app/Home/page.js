        ...
        <div>
                ...
                <div className="w-full flex justify-center pb-10">
                    <div className="w-[90%] sm:w-[90%] lg:w-[60%] bg-gray-100 rounded-lg">
                        <div className="flex justify-center gap-10 sm:gap-16">
                            <Image src="/Icons/amazon.png" width={90} height={30} alt="Logo img 1" className="w-[70px] h-[70px] sm:w-[130px] sm:h-[80px]"></Image>
                            <Image src="/Icons/forbes.png" width={90} height={30} alt="Logo img 2" className="w-[70px] h-[70px] sm:w-[130px] sm:h-[80px]"></Image>
                            <Image src="/Icons/hubspot.png" width={90} height={30} alt="Logo img 3" className="w-[70px] h-[70px] sm:w-[130px] sm:h-[80px]"></Image>
                        </div>
                        <div className="flex justify-center gap-10 sm:gap-16 mt-5">
                            <Image src="/Icons/snowflake.png" width={90} height={30} alt="Logo img 4" className="w-[70px] h-[70px] sm:w-[130px] sm:h-[80px]"></Image>
                            <Image src="/Icons/time.png" width={90} height={30} alt="Logo img 5" className="w-[70px] h-[70px] sm:w-[130px] sm:h-[80px]"></Image>
                            <Image src="/Icons/wsj.png" width={90} height={30} alt="Logo img 6" className="w-[70px] h-[70px] sm:w-[130px] sm:h-[80px]"></Image>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-white w-full flex flex-col lg:flex-row gap-5 py-10 px-1 md:py-16 md:px-16">
                <div className="w-full lg:w-[50%] px-10">
                    <h1 className="text-3xl md:text-4xl font-bold mt-3 md:mt-5">Powerful tech that’s easy to use</h1>
                    <p className="text-gray-600 text-md md:text-lg mt-3 md:mt-7">Streamline your most complex events with a full-scale, full-spectrum platform built to plan, promote, and produce.</p>
                    <ul>
                        <li className="text-gray-600 text-md md:text-lg mt-3 md:mt-5">Personalize attendee journeys with dynamic registration and multi-track agendas.</li>
                        <li className="text-gray-600 text-md md:text-lg mt-3 md:mt-5">Leverage a built-in event marketing suite, code-free templates, and integrations to fully customize the experience.</li>
                        <li className="text-gray-600 text-md md:text-lg mt-3 md:mt-5">Monitor event success indicators, engagement insights, and business outcomes.</li>
                    </ul>
                    <div className="mt-7">
            ...
            <div className="bg-[#fff000] w-full flex flex-col-reverse lg:flex-row gap-5 py-10 px-1 md:py-16 md:px-10">
                ...
                <div className="w-full lg:w-[50%] px-10">
                    <h1 className="text-3xl md:text-4xl font-bold mt-3 md:mt-5">Build sales pipeline and prove event ROI</h1>
                    <p className="text-black text-md md:text-lg mt-3 md:mt-7">Convert your events into revenue-generating opportunities and improve time-to-value for sponsors and sales teams alike.</p>
                    <ul>
                        <li className="text-black text-md md:text-lg mt-3 md:mt-5">Connect events to your CRM so data can flow in real-time.</li>
                        <li className="text-black text-md md:text-lg mt-3 md:mt-5">Supply go-to-market teams with actionable intent data.</li>
                        <li className="text-black text-md md:text-lg mt-3 md:mt-5">Arm your exhibitors with smart lead capture tools.</li>
                    </ul>
                    <div className="mt-7">
                        <button className=" bg-black sm:text-md text-white font-semibold px-7 py-2 rounded-2xl hover:scale-95">Learn More</button>
                    </div>
            ...
            <div className="bg-[#fff000] w-full py-10 px-1 md:py-12 md:px-10">
                <div>
                    <h1 className="text-3xl md:text-4xl font-bold text-center mt-7">The No.1-Rated event software</h1>
                </div>
                <div className="w-full flex justify-center">
                    <div className="w-full lg:w-[80%] grid grid-cols-1 lg:grid-cols-2 gap-10 mt-10">
                        <div className="flex justify-center md:items-center gap-4 shadow-2xl py-7 px-5 md:py-6 md:px-6 rounded-xl">
                            <div className="flex">
                                <Image src="/Images/TopEventImg1.png" width={50} height={50} alt="Manager Image" className="w-[100px] h-[90px] sm:w-[110px] sm:h-[110px] md:w-[110px] md:h-[130px]"></Image>
                            </div>
                            <div>
                                <h1 className="text-lg lg:text-xl font-semibold tracking-wide">Forrester Wave Leader</h1>
                                <p className="text-sm md:text-md text-gray-600">B2B Event Management Technology, 2023</p>
                            </div>
                        </div>
                        <div className="flex justify-center md:items-center gap-4 shadow-2xl py-7 px-5 md:py-6 md:px-6 rounded-xl">
                            <div className="flex">
                                <Image src="/Images/TopEventImg2.png" width={50} height={50} alt="Manager Image" className="w-[100px] h-[90px] sm:w-[110px] sm:h-[110px] md:w-[110px] md:h-[130px]"></Image>
                            </div>
                            <div>
                                <h1 className="text-lg lg:text-xl font-semibold tracking-wide">Inc. 5000 Honoree</h1>
