    ...
    <div>
        ...
        <div className='w-full lg:w-[26%] flex justify-center gap-5 shadow-xl px-6 py-4 rounded-xl border-[1px] border-gray-300'>
          <div className='flex justify-center'>
            <Image src="/TicketsIcon.png" width={30} height={30} alt="Tickets Icon" className='w-[65px] h-[65px] lg:w-[70px] lg:h-[70px]'></Image>
          </div>
        ...
        <div className='w-full lg:w-[26%] flex justify-center gap-5 shadow-xl px-6 py-4 rounded-xl border-[1px] border-gray-300'>
          <div className='flex justify-center'>
            <Image src="/SeatsIcon.png" width={30} height={30} alt="Seats Icon" className='w-[65px] h-[65px] lg:w-[70px] lg:h-[70px]'></Image>
          </div>
          <div className='text-center mt-1'>
        ...
        <div className='w-full lg:w-[26%] flex justify-center gap-5 shadow-xl px-6 py-4 rounded-xl border-[1px] border-gray-300'>
          <div className='flex justify-center'>
            <Image src="/BalanceIcon.png" width={30} height={30} alt="Balance Icon" className='w-[65px] h-[65px] lg:w-[70px] lg:h-[70px]'></Image>
          </div>
          <div className='text-center mt-1'>
